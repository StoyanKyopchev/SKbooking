  ...
  return (
    <>
      <div className="flex justify-center">
        <form
          className="flex flex-col items-center gap-3 pb-5 2xl:pb-0 w-full md:w-3/5 lg:w-3/5 xl:w-1/2 2xl:w-1/3 group"
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-3 md:gap-0 justify-between items-center w-full">
            <span>
              ...
              <Link to="/sign-up" className="text-sky-700 font-bold underline">
                Sign Up
              </Link>
            </span>
